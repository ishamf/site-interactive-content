...
<main>
  ...
  <xif-embedding-figure
    sentences="England,English king,Germany,German king,Italy,Italian king,King,Country"
  ></xif-embedding-figure>
  <xif-embedding-figure
    sentences="fast,slow,very fast,very slow, extremely fast, extremely slow,mindblowingly fast"
  ></xif-embedding-figure>
  <xif-embedding-figure
