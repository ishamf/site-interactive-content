...
export const dayColors: Record<number, string> = {
  ...
  2: 'oklch(61.33% 0.1707 142.94)',
  3: 'oklch(46.67% 0.1707 353.65)',
  4: 'oklch(68.67% 0.1707 45.53)',
  5: 'oklch(62.67% 0.1707 321.88)',
...
export const dayLightTextColors: Record<number, string> = {
  ...
  2: 'oklch(60.53% 0.1175 142.94)',
  3: 'oklch(60.53% 0.1175 353.65)',
  4: 'oklch(60.53% 0.1175 45.53)',
  5: 'oklch(60.53% 0.1175 321.88)',
...
export const dayDarkTextColors: Record<number, string> = {
  ...
  2: 'oklch(82.05% 0.0829 142.94)',
  3: 'oklch(82.05% 0.0829 353.65)',
  4: 'oklch(82.05% 0.0829 45.53)',
  5: 'oklch(82.05% 0.0829 321.88)',
